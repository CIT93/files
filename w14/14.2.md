...
* Create 3 new files `aqi-data-service.js`, `aqi-integrator.js` and `config.js`
    - Several files will be updated here.
        - Update the index.html to remove the script tag to `color-code.js` and uncomment the script tag for `app.js`
...
* Code the function
    - [Video](https://www.youtube.com/watch?v=GW4Cfetsj_g) - Right click and open in a new tab or window
        - `aqi-data-service.js`
    ...
    - Before moving on
        * **Git Workflow (Save Progress):**
            * Commit your changes with the message: **"get user location"**
